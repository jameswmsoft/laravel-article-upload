...
<div style="height:52px;margin: 10px 0 45px 50px;background-color:ghostwhite;padding-top: 15px" >
    <span style=" margin:15px; color: #5b9bd1;;font-size: 20px">Create Content</span>
    <br>
</div>
            ...
            <div class="span12">
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">Create Content</div>

                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="/index/admin/add" class="form-horizontal" method="post">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span10 m-wrap" name="title" value="">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        {{--<textarea class="span10 m-wrap" rows="5" name="content" val=""></textarea>--}}
                                        <textarea class="tinymce_editor" id="tinymce_editor"></textarea>
                                        <input type="hidden" name="phone_editor_type" value="html">
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <button type="button" class="btn blue addsubmit">Submit</button>
